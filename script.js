...
function optionselect(e) {
  ...
  fetch(`https://venial-implements.000webhostapp.com/restaurant.php?req=item&id=${id}`)
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
      ...
      small_price.innerHTML = "           small dish: " + data.price_small;
    })
    .catch((err) => console.log(err));
}
async function getdata() {
  await fetch("https://venial-implements.000webhostapp.com/restaurant.php?req=menuitems")
    .then((res) => res.json())
    .then((data) => {
